...
// 3. ViewModel
final childReportViewModelProvider = StateNotifierProvider<ChildReportViewModel, ChildReportState>((ref) {
  return ChildReportViewModel(ref.watch(childSafetyRepositoryProvider));
});

// 4. SETTINGS STREAM
final childSafetySettingsProvider = StreamProvider<ParentSafetySettingsModel>((ref) {
  return ref.watch(childSafetyServiceProvider).getSafetySettingsStream();
});
