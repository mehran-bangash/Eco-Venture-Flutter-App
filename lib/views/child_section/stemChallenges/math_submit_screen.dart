...
class _MathSubmitScreenState extends ConsumerState<MathSubmitScreen> with TickerProviderStateMixin {
          ...
          builder: (context, _) {
            ...
            return Stack(
              children: [
                ...
                Positioned(top: -5.h, right: -15.w, child: _buildGlowBlob(Colors.green.withOpacity(0.12), 70.w, t, 0)),
                Positioned(bottom: 5.h, left: -20.w, child: _buildGlowBlob(Colors.amber.withOpacity(0.08), 80.w, t, 2)),
