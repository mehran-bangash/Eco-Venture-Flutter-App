...
class _TechnologyInstructionScreenState extends State<TechnologyInstructionScreen> with TickerProviderStateMixin {
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: challenge.imageUrl != null && challenge.imageUrl!.isNotEmpty
                  ...
                  : Icon(Icons.computer_rounded, color: _themeColor.withOpacity(0.3), size: 30.sp),
            ),
          ),
          SizedBox(width: 4.w),
          Expanded(
  ...
  Widget _buildSubmitButton(StemChallengeReadModel challenge) {
    return GestureDetector(
      onTap: () => context.goNamed('technologySubmitScreen', extra: challenge),
      child: Container(
        width: 100.w,
        height: 7.h,
        decoration: BoxDecoration(
