...
class _ScienceInstructionScreenState extends State<ScienceInstructionScreen> with TickerProviderStateMixin {
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: challenge.imageUrl != null && challenge.imageUrl!.isNotEmpty
                  ...
                  : Icon(Icons.science_rounded, color: _themeColor.withOpacity(0.3), size: 30.sp),
            ),
          ),
          SizedBox(width: 4.w),
          Expanded(
  ...
  Widget _buildSubmitButton(StemChallengeReadModel challenge) {
    return GestureDetector(
      onTap: () => context.goNamed('scienceSubmitScreen', extra: challenge),
      child: Container(
        width: 100.w,
        height: 7.h,
        decoration: BoxDecoration(
