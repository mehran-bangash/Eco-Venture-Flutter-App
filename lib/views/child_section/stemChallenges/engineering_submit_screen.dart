...
class EngineeringSubmitScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EngineeringSubmitScreen> createState() => _EngineeringSubmitScreenState();
}

class _EngineeringSubmitScreenState extends ConsumerState<EngineeringSubmitScreen> with TickerProviderStateMixin {
          ...
          builder: (context, _) {
            ...
            return Stack(
              children: [
                ...
                Positioned(top: -5.h, right: -15.w, child: _buildGlowBlob(Colors.orange.withOpacity(0.12), 70.w, t, 0)),
                Positioned(bottom: 5.h, left: -20.w, child: _buildGlowBlob(Colors.indigo.withOpacity(0.08), 80.w, t, 2)),
