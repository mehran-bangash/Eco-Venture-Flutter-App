...
class TechnologySubmitScreen extends StatefulWidget {
  const TechnologySubmitScreen({super.key});

  @override
  State<TechnologySubmitScreen> createState() => _TechnologySubmitScreenState();
}

class _TechnologySubmitScreenState extends State<TechnologySubmitScreen> {
