...
class _EngineeringInstructionScreenState extends State<EngineeringInstructionScreen> with TickerProviderStateMixin {
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: challenge.imageUrl != null && challenge.imageUrl!.isNotEmpty
                  ...
                  : Icon(Icons.engineering_rounded, color: _themeColor.withOpacity(0.3), size: 30.sp),
            ),
          ),
          SizedBox(width: 4.w),
          Expanded(
