...
class _VideoPlayerScreenState extends ConsumerState<VideoPlayerScreen>
  ...
  Future<void> _initPlayer() async {
    ...
    try {
      ...
      _chewieController = ChewieController(
        ...
        // FIX: Add a placeholder to handle the loading delay visually
      ...
      if (!_viewAdded) {
        ref
            ...
            .incrementView(widget.videoData);
        _viewAdded = true;
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    final video =
        videoState.videos.firstWhereOrNull(
          (v) => v.id == widget.videoData.id,
        ) ??
        widget.videoData;
                ...
                SafeArea(
                  child: Column(
                    children: [
                      ...
                      _buildVideoArea(),
                      Expanded(
                        child: _buildInfoPanel(video, isLiked, isDisliked),
                      ),
                    ],
                  ),
                ),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(
              ...
              color: isActive
                  ? Colors.white
                  : (isAvailable ? _subText : _slate200),
              size: 19.sp,
            ),
          ),
        ),
