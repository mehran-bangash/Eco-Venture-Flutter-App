...
class TeacherSafetyDashboard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TeacherSafetyDashboard> createState() =>
      _TeacherSafetyDashboardState();
}

class _TeacherSafetyDashboardState
    extends ConsumerState<TeacherSafetyDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    final resolvedCount = alerts
        .where((a) => a.status.toLowerCase().contains('resolved'))
        .length;
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (alerts.isEmpty) _buildEmptyState() else _buildList(alerts),
            SizedBox(height: 6.h),
          ],
        ),
      ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isFromAdmin ? Colors.blue.withOpacity(0.05) : Colors.white,
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text: isFromAdmin ? "Support Team" : alert.fromName,
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                        if (isFromParent && !isFromAdmin) ...[
                        ...
                        TextSpan(text: " • ${timeago.format(alert.timestamp)}"),
                      ],
                    ),
                  ),
                ],
