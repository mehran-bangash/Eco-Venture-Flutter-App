...
class TeacherEditStemChallengeScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TeacherEditStemChallengeScreen> createState() => _TeacherEditStemChallengeScreenState();
}

class _TeacherEditStemChallengeScreenState extends ConsumerState<TeacherEditStemChallengeScreen> {
  // --- PRO COLORS ---
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    _fixedCategory,
                    style: GoogleFonts.poppins(fontSize: 16.sp, fontWeight: FontWeight.w600, color: Colors.grey.shade600),
                  ),
                ),
                SizedBox(height: 2.h),
      ...
      title: Column(
        children: [
          ...
          Container(
            ...
            child: Text(
              _fixedCategory,
              style: GoogleFonts.poppins(color: _primaryBlue, fontSize: 14.sp, fontWeight: FontWeight.w600),
            ),
          ),
        ],
      ),
        ...
        child: InkWell(
          ...
          child: imageProvider != null
            ...
            children: [
              ...
              Positioned(
                ...
                child: InkWell(
                  ...
                  child: CircleAvatar(backgroundColor: Colors.white, radius: 16, child: Icon(Icons.close, size: 20, color: Colors.red)),
                ),
              ),
            ],
          )
            ...
            children: [
              ...
              SizedBox(height: 1.h),
              Text("Tap to change image", style: GoogleFonts.poppins(fontSize: 15.sp, fontWeight: FontWeight.w600, color: Colors.grey.shade700)),
            ],
          ),
        ),
      ),
      ...
      children: _materials.map((material) {
        return Container(
          ...
          child: Row(
            ...
            children: [
              Text(material, style: GoogleFonts.poppins(fontSize: 15.sp, fontWeight: FontWeight.w600, color: _primaryBlue)),
              SizedBox(width: 1.w),
              InkWell(
                onTap: () => setState(() => _materials.remove(material)),
                child: Icon(Icons.close, size: 18.sp, color: _primaryBlue.withOpacity(0.7)),
              ),
            ],
          ),
        );
      ...
      itemBuilder: (context, index) {
        return Container(
          ...
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              CircleAvatar(radius: 15.sp, backgroundColor: _primaryBlue, child: Text("${index + 1}", style: TextStyle(color: Colors.white, fontSize: 15.sp, fontWeight: FontWeight.bold))),
              SizedBox(width: 3.w),
              ...
              InkWell(
                ...
                child: Icon(Icons.delete_outline, size: 20.sp, color: Colors.redAccent),
              ),
            ],
          ),
        );
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                label,
                style: GoogleFonts.poppins(fontSize: 16.sp, fontWeight: FontWeight.w600, color: _primaryBlue),
              ),
            ],
          ),
        ),
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: isLoading
                ...
                : Text("Update Challenge", style: GoogleFonts.poppins(fontSize: 17.sp, fontWeight: FontWeight.bold, color: Colors.white)),
          ),
        ),
        SizedBox(height: 2.h),
        TextButton(
          onPressed: isLoading ? null : () => Navigator.pop(context),
          child: Text("Cancel", style: GoogleFonts.poppins(fontSize: 15.sp, fontWeight: FontWeight.w600, color: Colors.grey.shade600)),
        ),
      ],
    );
  }
  ...
  void _showAddMaterialDialog() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: TextField(controller: _materialController, style: TextStyle(fontSize: 16.sp), decoration: InputDecoration(hintText: "e.g. 2 AA Batteries", border: OutlineInputBorder(borderRadius: BorderRadius.circular(8)))),
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx), child: Text("Cancel", style: TextStyle(fontSize: 15.sp))),
          ElevatedButton(
            onPressed: () {
            ...
            child: Text("Add", style: TextStyle(fontSize: 15.sp, color: Colors.white)),
          ),
        ],
      ),
    );
  ...
  void _showAddStepDialog() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: TextField(controller: stepCtrl, maxLines: 3, style: TextStyle(fontSize: 16.sp), decoration: InputDecoration(hintText: "Describe the step...", border: OutlineInputBorder(borderRadius: BorderRadius.circular(8)))),
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx), child: Text("Cancel", style: TextStyle(fontSize: 15.sp))),
          ElevatedButton(
            onPressed: () {
            ...
            style: ElevatedButton.styleFrom(backgroundColor: _primaryBlue),
            child: Text("Add", style: TextStyle(color: Colors.white, fontSize: 15.sp)),
          ),
        ],
      ),
    );
