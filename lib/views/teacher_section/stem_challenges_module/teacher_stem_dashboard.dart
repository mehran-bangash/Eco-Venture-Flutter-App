...
class _TeacherStemDashboardState extends ConsumerState<TeacherStemDashboard> {
  ...
  void _confirmDelete(StemChallengeModel challenge) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          "This will permanently remove '${challenge.title}' and all its media (images/videos) from the cloud.",
                ...
                child: stemState.isLoading
                    ...
                    ? SingleChildScrollView(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            "No challenges in $_selectedCategory",
                            style: GoogleFonts.poppins(
                              color: _textGrey,
                              fontSize: 15.sp,
                            ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image:
                  challenge.imageUrl != null &&
                      challenge.imageUrl!.startsWith('http')
                  ? DecorationImage(
            ...
            child: challenge.imageUrl == null
                ? Icon(Icons.science, color: _primary, size: 24.sp)
                : null,
          ),
          SizedBox(width: 4.w),
          Expanded(
          ...
          Column(
            children: [
              ...
              SizedBox(height: 1.5.h),
              InkWell(
                onTap: () => _confirmDelete(challenge),
                child: Container(
                  padding: EdgeInsets.all(2.w),
                  decoration: BoxDecoration(
