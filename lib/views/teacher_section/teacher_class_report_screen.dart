...
class TeacherClassReportScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final notifier = ref.read(teacherClassReportViewModelProvider.notifier);
                    ...
                    if (report.studentRankings.isEmpty)
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return _buildStudentRankTile(
                            index + 1,
                            report.studentRankings[index],
                          );
                        },
                      ),
                    SizedBox(height: 5.h),
  ...
  Widget _buildCategoryDropdown(String current, dynamic notifier) {
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          value: current,
          isExpanded: true,
          icon: Icon(Icons.filter_list, color: _primary),
          items: ["All", "6-8", "9-10", "11-12"]
              .map(
              ...
              .toList(),
          onChanged: (val) => notifier.setAgeCategory(val!),
        ),
      ),
    );
  }

  Widget _buildSearchBar(dynamic notifier) {
    return TextField(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                    "${report.classAverageScore.toInt()} XP",
                    style: GoogleFonts.poppins(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      fontSize: 11.sp,
  ...
  Widget _buildStudentRankTile(int rank, StudentRankItem student) {
    ...
    if (rank == 1) {
      ...
      rankColor = const Color(0xFFC0C0C0).withOpacity(0.2);
        ...
        children: [
          ...
          CircleAvatar(
            ...
            child: student.avatarUrl == null
                ? Icon(Icons.person, color: _primary, size: 16.sp)
                : null,
          ),
          SizedBox(width: 3.w),
          Expanded(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 1.h),
          Text(
            "No students or activity found yet.",
